...
Publishing Topics:
    /py_TS_topic (std_msgs/String): Example messages with incrementing counter
...
def test_publisher_creation():
    ...
    try:
        ...
        assert node.publisher_.topic_name == '/py_TS_topic'
    finally:
...
def test_message_content():
    ...
    try:
        ...
        msg.data = f'I love TS: {node.i}'
        assert msg.data == 'I love TS: 5'
    finally:
        rclpy.shutdown()
