 ...
 * 2. That it publishes the expected "I love TS" message
 *
 * Testing Framework:
...
TEST_F(TestMinimalPublisher, TestNodeCreation)
{
    ...
    auto pub_endpoints = node->get_publishers_info_by_topic("/cpp_TS_topic");
...
TEST_F(TestMinimalPublisher, TestMessageContent)
{
    ...
    EXPECT_EQ(received_msg->data.substr(0, 9), "I love TS");
}
