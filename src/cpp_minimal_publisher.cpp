...
public:
    ...
    void timerCallback()
    {
        ...
        message.data = "I love TS" +  std::to_string(count_++);
...
public:
  ...
  {
    publisher_ = this->create_publisher<std_msgs::msg::String>("cpp_TS_topic", 10);
    auto timer_callback =
      [this]() -> void {
        auto message = std_msgs::msg::String();
        message.data = "I love TS " + std::to_string(this->count_++);
